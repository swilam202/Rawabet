          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            for (int i = 0; i < snapshot.data!.docs.length; i++) {
              ...
              if ((message['sender'] == args['sender'] &&
                ...
                messagesList.add(Message(message['message'], message['sender'],
                    message['receiver']));
              }
            }
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return (messagesList[index].sender == args['sender'])
                            ? bubble(messagesList[index].messageContent)
                            : bubble2(messagesList[index].messageContent);
                      },
                    ),
                  ),
                ),
                        ...
                        onSubmitted: (data) {
                          if (data.isNotEmpty) {
                            ...
                            messagesList.add(Message(
                                data, args['sender'], args['receiver']));
                            controller.clear();
